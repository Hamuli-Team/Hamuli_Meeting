package com.hamuli.hamulimeeting.firebase;
...
import com.hamuli.hamulimeeting.activities.IncomingInvitationActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (type != null){
            if (type.equals(Constants.REMOTE_MSG_INVITATION)){
                ...
                intent.putExtra(
                        Constants.REMOTE_MSG_INVITOR_TOKEN,
                        remoteMessage.getData().get(Constants.REMOTE_MSG_INVITOR_TOKEN)
                );
                ...
                intent.putExtra(
                        Constants.REMOTE_MSG_INVITATION_ROOM,
                        remoteMessage.getData().get(Constants.REMOTE_MSG_INVITATION_ROOM)
                );
