...
public class OutgoingInvitationActivity extends AppCompatActivity {
        ...
        ApiClient.getClient().create(ApiService.class).sendRemoteMessage(
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(OutgoingInvitationActivity.this, response.message() + "responseeee", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
    ...
    private void cancelInvitation(String receiverToken, ArrayList<User> receivers) {
        try {
            ...
            sentRemoteMessage(body.toString(), Constants.REMOTE_MSG_INVITATION_RESPONSE);
